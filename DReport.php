...
<body>
	...
	<div class="content">
		...
		<p style="text-align: center; margin-left:50%; margin-top: -50px;font-size:20px;">Decision: <?php echo $decision=$_POST['Id'];?></p>
		<center>
		<table border="1">
			<h2>Decision Grade Report</h2>
			<tr>
			...
			$decision=$_POST['Id'];
			$sel="SELECT * FROM Grade WHERE Decision='$decision' ";
