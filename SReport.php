...
<body>
	...
	<div class="content">
		...
		<p style="text-align: center; margin-left:50%; margin-top: -50px;font-size:20px;">Candidate: <?php echo $Id=$_POST['Id'];?></p>
		<center>
		<table border="1">
			...
			$Id=$_POST['Id'];
			$sel="SELECT * FROM Grade WHERE CandidateNationalId='$Id'";
